...
export const getMenuContainerClass = (submenuPosition: SubmenuPosition): string =>
...
export const getMenuItemClass = (hasChildren: boolean): string =>
  hasChildren ? `${menuStyles.menu_item} ${menuStyles.menu_item_with_children}` : `${menuStyles.menu_item}`;

export const getMenuLevelClass = (isRoot: boolean): string =>
